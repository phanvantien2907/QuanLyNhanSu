...
namespace Login
{
    public partial class QuanLyChucVu : Form
    {
        ...
        public QuanLyChucVu(string vaiTro)
        {
            InitializeComponent();
            this.vaiTro = vaiTro;
        }
        ...
        {
            string sqlSelect = "select * from tb_ChucVu";
        ...
        private void btn_Them_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string checkQuery = "SELECT COUNT(*) FROM tb_ChucVu WHERE MachucVu = @MachucVu";
                ...
                {
                    string SQlInSert = "INSERT INTO tb_ChucVu (Ten_Chucvu) VALUES (@Ten_ChucVu)";
                    SqlCommand cmd = new SqlCommand(SQlInSert, conn);
                    cmd.Parameters.AddWithValue("Ten_ChucVu", txt_Tenchucvu.Text);
        ...
        private void btn_Sua_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(txt_Tenchucvu.Text) || string.IsNullOrEmpty(txt_Machucvu.Text))
                {
                    MessageBox.Show("Vui lòng nhập đầy đủ thông tin!", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                ...
                {
                    string SQlUpDate = "UPDATE tb_ChucVu SET Ten_ChucVu = @Ten_ChucVu WHERE Machucvu = @Machucvu";
        ...
        private void btn_Xoa_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    string sqlDelete = "DELETE FROM tb_ChucVu WHERE Machucvu = @Machucvu";
        ...
        private void btn_TimKiem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(txt_TimKiem.Text))
                {
                    ...
                    string sqltimKiem = "SELECT * FROM tb_ChucVu WHERE Machucvu LIKE @Machucvu OR Ten_ChucVu LIKE @Ten_ChucVu";


                    // Tạo SqlCommand và thêm tham số cho câu truy vấn
                    SqlCommand cmd = new SqlCommand(sqltimKiem, conn);
                    cmd.Parameters.AddWithValue("@Machucvu", "%" + txt_TimKiem.Text + "%");
                    cmd.Parameters.AddWithValue("@Ten_ChucVu", "%" + txt_TimKiem.Text + "%");
        ...
        private void dtgv_DuLieu_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (rowIndex >= 0 && rowIndex < dtgv_DuLieu.Rows.Count)
            {
                ...
                txt_Tenchucvu.Text = selectedRow.Cells["Ten_ChucVu"].Value.ToString();
            }
        }
    }
}
